...
N-dimensional array type and foundational primitives for the [ferrum](https://crates.io/crates/ferrum) scientific computing library.
...
This crate is re-exported through the main [`ferrum`](https://crates.io/crates/ferrum) crate. Most users should depend on `ferrum` directly.
