...
One ufunc errstate behavior gap is explicit: the public errstate
...
here is the known behavior gap: wiring ufunc kernels to emit floating-point
events into errstate.
