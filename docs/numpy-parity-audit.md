...
Current Rust direct-or-accepted surface evidence: 2,185 of 2,949 inventoried
items, or 74.1%. The remaining 764 items are still represented by exclusion
...
autodiff, FFT, polynomial, stats, stride-tricks, IO, ufunc, and window. Direct ufunc wrapper,
operator-wrapper,
...
exclusion debt to zero; random core generator,
