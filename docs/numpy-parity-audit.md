...
Current Rust direct-or-accepted surface evidence: 2,061 of 2,949 inventoried
items, or 69.9%. The remaining 888 items are still represented by exclusion
...
autodiff, FFT, stats, stride-tricks, IO, ufunc, and window. Direct ufunc wrapper,
operator-wrapper,
