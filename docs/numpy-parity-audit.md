...
Current Rust direct-or-accepted surface evidence: 1,710 of 2,949 inventoried
items, or 58.0%. The remaining 1,239 items are still represented by exclusion
...
helpers have reduced `ferray-random` exclusion debt to 9 private/internal
entries; masked-array axis
