...
`__richcmp__` over the six comparison operators) are SHIPPED. REQ-3 (R-C bitwise)
and REQ-5 (R-E integer-dtype domain masking) remain NOT-STARTED with open prereq
blockers #865 / #864. See the per-REQ table below.
