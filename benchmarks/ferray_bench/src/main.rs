...
//!   echo '[1.0, 2.0, 3.0]' | ferray-bench <function> <size> [extra_args...]
//!
...
fn main() {
    ...
    if args.len() < 2 {
        eprintln!("Usage: ferray-bench <function> <size> [extra_args...]");
        eprintln!("       ferray-bench batch  (reads batch JSON from stdin)");
...
fn dispatch_single(
    ...
    match func_name {
        ...
        "sin" => run_unary_ufunc(input_data, size_str, ferray_ufunc::sin),
        "cos" => run_unary_ufunc(input_data, size_str, ferray_ufunc::cos),
        "tan" => run_unary_ufunc(input_data, size_str, ferray_ufunc::tan),
        "exp" => run_unary_ufunc(input_data, size_str, ferray_ufunc::exp),
        "log" => run_unary_ufunc(input_data, size_str, ferray_ufunc::log),
        "log2" => run_unary_ufunc(input_data, size_str, ferray_ufunc::log2),
        "log10" => run_unary_ufunc(input_data, size_str, ferray_ufunc::log10),
        "sqrt" => run_unary_ufunc(input_data, size_str, ferray_ufunc::sqrt),
        "abs" => run_unary_ufunc(input_data, size_str, ferray_ufunc::absolute),
        "exp2" => run_unary_ufunc(input_data, size_str, ferray_ufunc::exp2),
        "expm1" => run_unary_ufunc(input_data, size_str, ferray_ufunc::expm1),
        "log1p" => run_unary_ufunc(input_data, size_str, ferray_ufunc::log1p),
        "arcsin" => run_unary_ufunc(input_data, size_str, ferray_ufunc::arcsin),
        "arccos" => run_unary_ufunc(input_data, size_str, ferray_ufunc::arccos),
        "arctan" => run_unary_ufunc(input_data, size_str, ferray_ufunc::arctan),
        "sinh" => run_unary_ufunc(input_data, size_str, ferray_ufunc::sinh),
        "cosh" => run_unary_ufunc(input_data, size_str, ferray_ufunc::cosh),
        "tanh" => run_unary_ufunc(input_data, size_str, ferray_ufunc::tanh),
        "cbrt" => run_unary_ufunc(input_data, size_str, ferray_ufunc::cbrt),
        "ceil" => run_unary_ufunc(input_data, size_str, ferray_ufunc::ceil),
        "floor" => run_unary_ufunc(input_data, size_str, ferray_ufunc::floor),
        "rint" => run_unary_ufunc(input_data, size_str, ferray_ufunc::rint),
        "sign" => run_unary_ufunc(input_data, size_str, ferray_ufunc::sign),
        "square" => run_unary_ufunc(input_data, size_str, ferray_ufunc::square),
        "negative" => run_unary_ufunc(input_data, size_str, ferray_ufunc::negative),
        "reciprocal" => run_unary_ufunc(input_data, size_str, ferray_ufunc::reciprocal),

        // ---- Stats: reductions ----
        "mean" => run_reduction(input_data, size_str, |arr| ferray_stats::mean(arr, None)),
        "var" => run_reduction(input_data, size_str, |arr| ferray_stats::var(arr, None, 0)),
        "std" => run_reduction(input_data, size_str, |arr| ferray_stats::std_(arr, None, 0)),
        "sum" => run_reduction(input_data, size_str, |arr| ferray_stats::sum(arr, None)),
...
fn dispatch_timed(func_name: &str, size_str: &str, input_data: &[f64]) -> u64 {
    match func_name {
        "sin" => time_unary_ufunc(input_data, ferray_ufunc::sin),
        "cos" => time_unary_ufunc(input_data, ferray_ufunc::cos),
        "tan" => time_unary_ufunc(input_data, ferray_ufunc::tan),
        "exp" => time_unary_ufunc(input_data, ferray_ufunc::exp),
        "log" => time_unary_ufunc(input_data, ferray_ufunc::log),
        "log2" => time_unary_ufunc(input_data, ferray_ufunc::log2),
        "log10" => time_unary_ufunc(input_data, ferray_ufunc::log10),
        "sqrt" => time_unary_ufunc(input_data, ferray_ufunc::sqrt),
        "abs" => time_unary_ufunc(input_data, ferray_ufunc::absolute),
        "exp2" => time_unary_ufunc(input_data, ferray_ufunc::exp2),
        "expm1" => time_unary_ufunc(input_data, ferray_ufunc::expm1),
        "log1p" => time_unary_ufunc(input_data, ferray_ufunc::log1p),
        "arcsin" => time_unary_ufunc(input_data, ferray_ufunc::arcsin),
        "arccos" => time_unary_ufunc(input_data, ferray_ufunc::arccos),
        "arctan" => time_unary_ufunc(input_data, ferray_ufunc::arctan),
        "sinh" => time_unary_ufunc(input_data, ferray_ufunc::sinh),
        "cosh" => time_unary_ufunc(input_data, ferray_ufunc::cosh),
        "tanh" => time_unary_ufunc(input_data, ferray_ufunc::tanh),
        "cbrt" => time_unary_ufunc(input_data, ferray_ufunc::cbrt),
        "ceil" => time_unary_ufunc(input_data, ferray_ufunc::ceil),
        "floor" => time_unary_ufunc(input_data, ferray_ufunc::floor),
        "rint" => time_unary_ufunc(input_data, ferray_ufunc::rint),
        "sign" => time_unary_ufunc(input_data, ferray_ufunc::sign),
        "square" => time_unary_ufunc(input_data, ferray_ufunc::square),
        "negative" => time_unary_ufunc(input_data, ferray_ufunc::negative),
        "reciprocal" => time_unary_ufunc(input_data, ferray_ufunc::reciprocal),
        "mean" => time_reduction(input_data, |arr| ferray_stats::mean(arr, None)),
        "var" => time_reduction(input_data, |arr| ferray_stats::var(arr, None, 0)),
        "std" => time_reduction(input_data, |arr| ferray_stats::std_(arr, None, 0)),
        "sum" => time_reduction(input_data, |arr| ferray_stats::sum(arr, None)),
...
fn run_matmul(input_data: &[f64], size_str: &str) -> (serde_json::Value, u64) {
    ...
    let start = Instant::now();
    let result = ferray_linalg::matmul(&a, &b).expect("matmul failed");
    let elapsed_ns = start.elapsed().as_nanos() as u64;
...
fn run_fft(input_data: &[f64], _size_str: &str) -> (serde_json::Value, u64) {
    ...
    let start = Instant::now();
    let result =
        ferray_fft::fft(&arr, None, None, ferray_fft::FftNorm::Backward).expect("FFT failed");
    let elapsed_ns = start.elapsed().as_nanos() as u64;
